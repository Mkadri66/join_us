...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $roles = $em->getRepository('RoleBundle:Role')->findAll();
    ...
    {
        $role = new Role();
        $form = $this->createForm('RoleBundle\Form\RoleType', $role);
    ...
    {
        $deleteForm = $this->createDeleteForm($role);
        $editForm = $this->createForm('RoleBundle\Form\RoleType', $role);
