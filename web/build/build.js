                        ...
                        $.ajax({
                                    ...
                                    success: function success(data) {
                                                ...
                                                for (var i = 0; i < data_length; i++) {
                                                            ...
                                                            $('<li> <img class="avatar_partie" src="../../../../uploads/avatars/' + url + '"  class="mx-auto d-block"> ' + username + ' </li>').appendTo(".users").hide().fadeIn(2000);
                                                }
                                    },
