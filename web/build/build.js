        ...
        $.ajax({
            ...
            success: function success(data) {
                ...
                for (var i = 0; i < count; i++) {
                    ...
                    url = data[i]["url"];
                    $('<li> <img class="avatar_partie" src="../../../../uploads/avatars/' + url + '" class="mx-auto d-block"> ' + username + ' </li>').appendTo(".users").hide().fadeIn(1000);
                }
            },
